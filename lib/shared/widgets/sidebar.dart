...
import 'package:ASPN_AI_AGENT/ui/screens/admin_leave_approval_screen.dart'; // 관리자 휴가관리 화면 추가
import 'package:ASPN_AI_AGENT/ui/screens/contest_screen.dart'; // 사내AI 공모전 화면 추가
...
class SidebarState extends ConsumerState<Sidebar>
                              ...
                              decoration: BoxDecoration(
                                color: isCurrentTopic
                                    ? (themeState.themeMode ==
                                            AppThemeMode.light
                                        ? (topic == 'AI Chatbot'
                                            ? const Color(0xFF6B46C1).withValues(
                                                alpha:
                                                    0.08) // AI Chatbot은 은은한 보라색
                                            : const Color(
                                                0xFFE5E7EB)) // 다른 아카이브는 밝은 회색 (선택됨)
                                        : Colors.white.withValues(
                                            alpha: 0.1)) // Dark 테마: 밝은 흰색 투명도
                                    : isHovered
                                        ? (themeState.themeMode ==
                                                AppThemeMode.light
                                            ? (topic == 'AI Chatbot'
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // 전자결재 버튼 (조건부 표시)
                if (FeatureConfig.showElectronicApproval) ...[
                  _buildWorkMenuItem(
                    context,
  ...
  Widget _buildWorkMenuItem(
    ...
    final bool isContest = title == '사내AI 공모전';
            ...
            decoration: BoxDecoration(
              ...
              gradient: isContest
                  ? LinearGradient(
                      ...
                      colors: isDarkMode
                          ? [
                              const Color(0xFF7C2D12), // deep amber brown
                              const Color(0xFFB45309), // amber
                              const Color(0xFF9333EA), // purple accent
                            ]
                          : [
                              const Color(0xFFFFEDD5), // light amber
              ...
              boxShadow: [
                BoxShadow(
                  ...
                  blurRadius: isContest ? 12 : 4,
                  offset: isContest ? const Offset(0, 4) : const Offset(0, 1),
                  spreadRadius: isContest ? 1 : 0,
                ),
              ],
            ),
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(
                    icon,
                    color: isContest
                        ? (isDarkMode ? Colors.white : const Color(0xFFB45309))
                ...
                Icon(
                  ...
                  color: isContest
                      ? (isDarkMode ? Colors.white70 : const Color(0xFF92400E))
                      : (isDarkMode
                          ? Colors.grey[400]
  ...
  // 사내AI 공모전 화면으로 네비게이션
  void _navigateToContest(BuildContext context) {
    Navigator.push(
      context,
